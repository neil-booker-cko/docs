...
| Plane | Standards |
| --- | --- |
| **Management** | Equipment Configuration, Security Hardening (AAA, SSH, SNMP), Meraki Cloud Networking (site-wide, admin, alerts), Naming Standards, Software Standards |
| **Control** | BGP Configuration, Routing Design, Connectivity Standards, Meraki Cloud Networking (OSPF, DHCP, ACLs), Security Hardening (BGP auth, logging) |
| **Data** | Connectivity Standards (forwarding), VPN Standards (IPsec), Meraki Cloud Networking (switch forwarding, traffic shaping), Security Hardening (data plane ACLs) |
| **Infrastructure** | Equipment Standards, Meraki Cloud Networking (cloud management), IP Addressing, Software Standards, Equipment Configuration |
